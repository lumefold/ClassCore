      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-20 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-slate-800 tracking-tight">ClassCore</h1>
              <p className="text-xs text-slate-500 font-medium">Student Success Platform</p>
            </div>
          </div>
          <button 
        ...
        {lectures.length > 0 && (
          <div className="mb-8">
            <div className="relative max-w-xl">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-3 border border-slate-200 rounded-xl leading-5 bg-white placeholder-slate-400 focus:outline-none focus:placeholder-slate-500 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 sm:text-sm shadow-sm transition-all"
